        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-500">
              {totalUsed.toFixed(1)}TB / {totalCapacity}TB used
            </p>
          </div>
        </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-xs mb-1">
                ...
                <span className="text-blue-400 font-bold">
                  {totalUsed.toFixed(1)} TB / {totalCapacity} TB
                </span>
              </div>
              ...
              <div className="grid grid-cols-4 gap-2 pt-2">
                {Object.entries(CLOUD_ROLES).map(([role, info]) => {
                  ...
                  return (
                    <div
                      key={role}
                      className={`bg-gradient-to-br ${info.color} rounded-lg p-2 border border-black/30`}
                    >
                      <div className="text-[9px] font-bold text-white">{info.label}</div>
                      <div className="text-[10px] text-white/80 mt-1">
                        {roleUsed.toFixed(1)} / {roleCapacity} TB
                      </div>
                    </div>
                  );
                })}
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <select
                    ...
                    onChange={(e) =>
                      setNewProviderForm({ ...newProviderForm, type: e.target.value as any })
                    }
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setNewProviderForm({ ...newProviderForm, role: e.target.value as any })
                    }
                    className="px-3 py-2 bg-zinc-800 border border-zinc-700 rounded text-xs text-white"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewProviderForm({
                        ...newProviderForm,
                        size_tb: parseFloat(e.target.value) || 0,
                      })
                    }
                    className="w-full px-3 py-2 bg-zinc-800 border border-zinc-700 rounded text-xs text-white placeholder-zinc-600"
                  />
                    ...
                    >
                      ...
                      <div className="space-y-1.5">
                        <div className="flex justify-between text-[10px] text-zinc-400">
                          ...
                          <span
                            className={
                              provider.status === "connected" ? "text-emerald-400" : "text-red-400"
                            }
                          >
                        ...
                        <div className="h-1.5 bg-zinc-800 rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width:
                                provider.size_tb > 0
                                  ? `${(provider.used_tb / provider.size_tb) * 100}%`
                                  : "0%",
                            }}
                          />
                        </div>
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
              ...
              <div className="space-y-3">
                ...
                <div className="text-xs text-zinc-400 p-2 bg-zinc-950 rounded border border-zinc-800">
                  <p>
                    <span className="text-white font-bold">Status:</span> Pipeline framework
                    configured. Ready to connect real clouds.
                  </p>
                </div>
              </div>
            </div>
