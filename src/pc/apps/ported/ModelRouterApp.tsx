...
const FREE_AI_MODELS: Record<string, ModelProvider> = {
    ...
    models: [
      {
        ...
        contextWindow: 8192,
        downloadUrl: "ollama.ai/library/llama:70b",
        isLocal: true,
      },
      {
        id: "llama-3.1-405b",
        ...
        downloadUrl: "ollama.ai/library/llama:405b",
        isLocal: true,
      },
      {
        id: "llama-3.1-70b",
      ...
      },
      {
        ...
        contextWindow: 8192,
        downloadUrl: "ollama.ai/library/llama:8b",
        isLocal: true,
      },
      {
        id: "mistral-7b",
        ...
        reasoning_level: "intermediate",
        contextWindow: 32768,
        downloadUrl: "ollama.ai/library/mistral",
        isLocal: true,
      },
      {
        id: "neural-chat-7b",
        ...
        contextWindow: 4096,
        downloadUrl: "ollama.ai/library/neural-chat",
        isLocal: true,
      },
      {
        id: "dolphin-mixtral",
        ...
        reasoning_level: "advanced",
        contextWindow: 32768,
        downloadUrl: "ollama.ai/library/dolphin-mixtral",
        isLocal: true,
      },
      {
        id: "hermes-2-pro",
        ...
        reasoning_level: "intermediate",
        contextWindow: 4096,
        downloadUrl: "ollama.ai/library/hermes2-pro",
        isLocal: true,
      },
      {
        id: "vicuna-13b",
        ...
        reasoning_level: "intermediate",
        contextWindow: 4096,
        downloadUrl: "ollama.ai/library/vicuna",
        isLocal: true,
      },
      {
        id: "zephyr-7b",
        ...
        reasoning_level: "intermediate",
        contextWindow: 4096,
        downloadUrl: "ollama.ai/library/zephyr",
        isLocal: true,
      },
    ],
  },
  ...
  openrouter_free: {
    ...
    models: [
      ...
      {
        id: "neural-chat-7b-or",
        name: "Neural Chat 7B",
        type: "chat",
        speedRating: "fast",
        reasoning_level: "basic",
        costPerMRequest: 0.0005,
        contextWindow: 4096,
      },
    ],
  },
  ...
  replicate_free: {
    ...
    models: [
      ...
      {
        id: "mistral-7b-instruct-replicate",
        name: "Mistral 7B Instruct",
        type: "instruct",
        speedRating: "fast",
        reasoning_level: "intermediate",
...
export const ModelRouterApp: React.FC = () => {
  ...
  const [routingMode, setRoutingMode] = useState<"free_first" | "balanced" | "performance">(
    "free_first",
  );
    ...
    for (const provider of activeProviders.sort((a, b) => a.priority - b.priority)) {
      for (const model of provider.models) {
        ...
        if (
          ...
          provider.monthlyUsed &&
          provider.monthlyUsed >= provider.monthlyBudget
        ) {
  ...
  const totalFreeModels = Object.values(FREE_AI_MODELS).reduce(
  ...
  const getModelScore = (model: AIModel): number => {
    ...
    const reasoningScore =
      model.reasoning_level === "advanced" ? 10 : model.reasoning_level === "intermediate" ? 5 : 2;
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-500">
              {activeProviders} providers • {totalFreeModels} free models
            </p>
          </div>
        </div>
        <button
            ...
            <>
                        ...
                        {provider.type === "paid_cloud" && (
                          <div className="space-y-1">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                updateProviderBudget(provider.id, parseFloat(e.target.value) || 0)
                              }
              ...
              {!showAddProvider ? (
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2 max-h-64 overflow-y-auto">
                    {Object.entries(FREE_AI_MODELS)
                      .filter(([_, p]) => !providers.find((prov) => prov.id === p.id))
                      .map(([key, provider]) => (
                        <button
                          key={key}
              ...
              <div className="bg-emerald-950/30 border border-emerald-700/30 rounded-lg p-3 space-y-1">
                ...
                <p className="text-[9px] text-emerald-300/80">
                  This router always prioritizes free models and local Ollama. Paid APIs are only
                  used if you explicitly set a budget and enable them. Never forced.
                </p>
              </div>
            </>
          )}
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 space-y-3">
                ...
                <div className="space-y-2">
                  {topModels.map((item, i) => (
                    <div
                      key={i}
                      className="bg-zinc-950 rounded-lg p-2 border border-zinc-800 flex items-center justify-between"
                    >
                      <div>
                  ...
                  <div className="text-lg font-bold text-emerald-400">
                    {
                      providers
                        .flatMap((p) => p.models)
                        .filter((m) => !m.costPerMRequest || m.costPerMRequest === 0).length
                    }
                  </div>
                </div>
                <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-3 space-y-1">
                  ...
                  <div className="text-lg font-bold text-yellow-400">
                    {
                      providers
                        .flatMap((p) => p.models)
                        .filter((m) => m.speedRating === "ultrafast").length
                    }
                  </div>
                </div>
              </div>
