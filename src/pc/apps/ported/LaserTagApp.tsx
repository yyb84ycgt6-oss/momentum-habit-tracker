...
export const LaserTagApp: React.FC = () => {
    ...
    >
      ...
      {(!isPlaying || gameOver) && (
        <div className="absolute inset-0 z-20 bg-black/80 backdrop-blur-sm flex flex-col items-center justify-center text-white animate-in fade-in duration-300">
          ...
          {gameOver && (
            <div className="text-3xl text-red-500 font-bold mb-2 animate-pulse">GAME OVER</div>
          )}
          ...
          {!gameOver && (
            <div className="text-zinc-400 mb-8 text-center space-y-2 text-sm">
              <p>
                Use{" "}
                <span className="text-white font-bold bg-zinc-800 border border-zinc-700 px-1.5 py-0.5 rounded">
                  ←
                </span>{" "}
                <span className="text-white font-bold bg-zinc-800 border border-zinc-700 px-1.5 py-0.5 rounded">
                  →
              ...
              <p>
                Press{" "}
                <span className="text-white font-bold bg-zinc-800 border border-zinc-700 px-2 py-0.5 rounded">
                  SPACE
                </span>{" "}
                to fire
              </p>
