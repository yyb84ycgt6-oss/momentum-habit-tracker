...
const TOOLS_DATABASE: Tool[] = [
  // AI/LLM
  {
    ...
    category: "AI/LLM",
    type: "API",
    description: "High-speed LLM inference platform",
    pricing: "Free",
    url: "https://groq.com",
    docs: "https://console.groq.com/docs",
    features: ["Mixtral", "Llama 2", "Ultra-fast inference"],
    setupTime: "5 min",
    requiresKey: true,
    apiKeyField: "GROQ_API_KEY",
    rating: 5,
    estimatedMonthlyCost: 0,
    freeUsageTier: "Unlimited free tier",
  },
  {
    id: "ollama",
    name: "Ollama",
    category: "AI/LLM",
    type: "Local",
    description: "Run LLMs locally with simple setup",
    pricing: "Free",
    url: "https://ollama.ai",
    docs: "https://github.com/ollama/ollama",
    features: ["Local execution", "No internet needed", "Multiple models"],
    setupTime: "10 min",
    requiresKey: false,
    rating: 5,
  },
  {
    ...
    features: ["Multiple models", "Cost aggregation", "Fallback routing"],
    setupTime: "5 min",
    requiresKey: true,
  ...
  },
  {
    ...
    features: ["Multimodal", "Vision", "Text generation"],
    setupTime: "5 min",
    requiresKey: true,
  ...
  },
  {
    ...
    features: ["Model hub", "Inference API", "Transformers"],
    setupTime: "10 min",
    requiresKey: true,
    apiKeyField: "HF_TOKEN",
    rating: 5,
  },
  {
    id: "together",
    ...
    category: "AI/LLM",
    type: "API",
    description: "Open-source model API platform",
    pricing: "Free trial + usage-based",
    url: "https://www.together.ai",
    docs: "https://www.together.ai/documentation",
    features: ["Multiple OSS models", "Fast inference", "Low cost"],
    setupTime: "5 min",
    requiresKey: true,
  ...
  },
  {
    ...
    features: ["Advanced reasoning", "Real-time info", "Code understanding"],
    setupTime: "5 min",
    requiresKey: true,
  ...
  },
  {
    ...
    category: "AI/LLM",
    type: "API",
    description: "Cost-effective LLM inference",
    pricing: "Very cheap",
    url: "https://www.deepseek.com",
    docs: "https://platform.deepseek.com/api-docs",
    features: ["Low cost", "Multiple models", "Good performance"],
    setupTime: "5 min",
    requiresKey: true,
  ...
  // Dev Tools
  {
    ...
    features: ["Code linting", "Configurable rules", "Auto-fix"],
    setupTime: "5 min",
    requiresKey: false,
    rating: 5,
  },
  {
    ...
    features: ["Auto formatting", "Language support", "IDE integration"],
    setupTime: "2 min",
    requiresKey: false,
    rating: 5,
  },
  {
    ...
    features: ["Unit testing", "Snapshot testing", "Coverage"],
    setupTime: "5 min",
    requiresKey: false,
    rating: 5,
  },
  {
    ...
    features: ["Type safety", "IDE support", "Compilation"],
    setupTime: "10 min",
    requiresKey: false,
    rating: 5,
  },
  {
    ...
    features: ["Containerization", "Compose", "Registry"],
    setupTime: "20 min",
    requiresKey: false,
    rating: 5,
  },
  {
    ...
    features: ["Distributed VCS", "Branching", "Merging"],
    setupTime: "5 min",
    requiresKey: false,
    rating: 5,
  },
  ...
  },
  {
    ...
    features: ["Server-side JS", "npm ecosystem", "Event-driven"],
    setupTime: "10 min",
    requiresKey: false,
    rating: 5,
  },
  {
    ...
    features: ["Bundling", "Code splitting", "Plugins"],
    setupTime: "15 min",
    requiresKey: false,
    rating: 4.5,
  },
  ...
  // Data Science
  {
    ...
    features: ["DataFrames", "CSV/Excel support", "Data cleaning"],
    setupTime: "5 min",
    requiresKey: false,
    rating: 5,
  },
  {
    ...
    features: ["Arrays", "Linear algebra", "Math functions"],
    setupTime: "5 min",
    requiresKey: false,
    rating: 5,
  },
  {
    ...
    features: ["Charts", "Plots", "Animations"],
    setupTime: "5 min",
    requiresKey: false,
    rating: 4.5,
  },
  {
    ...
    category: "Data Science",
    type: "Database",
    description: "In-process SQL database",
    pricing: "Free",
    url: "https://duckdb.org",
    docs: "https://duckdb.org/docs",
    features: ["SQL queries", "CSV/Parquet support", "Fast analytics"],
    setupTime: "5 min",
    requiresKey: false,
    rating: 5,
  },
  ...
  // Cloud/Infrastructure
  {
    ...
    features: ["Cloud management", "Scripting", "Automation"],
    setupTime: "10 min",
    requiresKey: true,
    apiKeyField: "AWS_ACCESS_KEY_ID",
    rating: 4.5,
  },
  {
    id: "terraform",
    ...
    features: ["IaC", "Multi-cloud", "State management"],
    setupTime: "15 min",
    requiresKey: false,
    rating: 5,
  },
  ...
  // Database
  {
    ...
    features: ["SQL", "ACID compliance", "Extensions"],
    setupTime: "10 min",
    requiresKey: false,
    rating: 5,
  },
  {
    ...
    features: ["Document storage", "Flexible schema", "Indexing"],
    setupTime: "10 min",
    requiresKey: false,
    rating: 4.5,
  },
  {
    ...
    features: ["Caching", "Sessions", "Real-time data"],
    setupTime: "5 min",
    requiresKey: false,
    rating: 5,
  },
...
export const ToolRegistryApp: React.FC = () => {
  ...
  const markSetupComplete = (toolId: string) => {
    setInstalledTools(
      installedTools.map((t) => (t.toolId === toolId ? { ...t, setupCompleted: true } : t)),
    );
  };
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="bg-slate-800 rounded p-3 border border-slate-700">
                ...
                <div className="text-[10px] text-slate-500 mt-1">
                  {setupCompletedCount} configured
                </div>
              </div>
              <div className="bg-slate-800 rounded p-3 border border-slate-700">
                <div className="text-slate-400 text-xs mb-1">Available</div>
                <div className="text-2xl font-bold text-purple-400">
                  {TOOLS_DATABASE.length - totalInstalledCount}
                </div>
              ...
              <div className="bg-slate-800 rounded p-3 border border-slate-700">
                ...
                <div className="bg-slate-700 rounded-full h-2 mb-2">
                  <div
                    ...
                    style={{
                      width: `${totalInstalledCount > 0 ? (setupCompletedCount / totalInstalledCount) * 100 : 0}%`,
                    }}
                  />
                </div>
              ...
              <div className="bg-slate-800 rounded p-3 border border-slate-700">
                ...
                <div className="text-2xl font-bold text-blue-400">
                  ...
                  {totalInstalledCount > 0
                    ? (totalCostUsed / totalInstalledCount).toFixed(2)
                    : "0.00"}
                </div>
                ...
                <div className="text-2xl font-bold text-emerald-400">
                  {
                    installedTools.filter(
                      (t) => TOOLS_DATABASE.find((x) => x.id === t.toolId)?.freeUsageTier,
                    ).length
                  }
                </div>
                    ...
                    <div className="mb-3">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {tool.features.slice(0, 2).map((f, i) => (
                          <span
                            key={i}
                            className="px-2 py-1 bg-slate-600 text-xs text-slate-200 rounded"
                          >
                            {f}
                          </span>
                        ))}
                    ...
                    {tool.requiresKey && (
                      <div className="mb-3">
                        ...
                        >
                          ...
                          <ChevronDown
                            size={14}
                            className={`transition ${expandedTool === tool.id ? "rotate-180" : ""}`}
                          />
                        </button>
