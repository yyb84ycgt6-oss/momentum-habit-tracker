...
const AGENT_TEMPLATES: Record<
  string,
  { name: string; role: SmallAgent["role"]; prompt: string; memoryMB: number }
> = {
  coder: {
    name: "Code Coder",
    role: "coder",
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-500">
              {totalMemoryMB} MB • {agents.length} agents
            </p>
          </div>
        </div>
                ...
                <>
                  ...
                  <div className="p-4 border-b border-zinc-800/50 bg-[#0f1115]">
                    ...
                    <div className="text-[10px] text-zinc-400 space-y-1">
                      <div>
                        <span className="text-zinc-500">Memory:</span> {agent.estimatedMemoryMB} MB
                      </div>
                      <div>
                        <span className="text-zinc-500">Tasks:</span> {agent.taskCount}
                      </div>
                      <div>
                        <span className="text-zinc-500">Status:</span>{" "}
                        <span className="text-emerald-400 font-mono">{agent.status}</span>
                      </div>
                    </div>
                  </div>
