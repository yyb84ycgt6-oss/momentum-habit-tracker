...
export const PCWindowControls: React.FC<PCWindowControlsProps> = ({
  ...
  const minimize = (e: React.SyntheticEvent) => {
    stop(e);
    onMinimize?.();
  };
    ...
    return (
      <div className="flex items-center" style={{ gap: controls === "gnome" ? 6 : 7 }}>
        {mk(
          ...
          "Close",
          controls === "gnome"
            ? "var(--pc-tl-close, rgba(127,127,127,0.25))"
  ...
  return (
    <div
      ...
      style={{
        ...
        alignSelf:
          controls === "aero" || controls === "metro" || controls === "fluent"
            ? "flex-start"
            : "center",
      }}
    >
